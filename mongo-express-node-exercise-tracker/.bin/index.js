    ...
    .exec((err, data) => {
      ...
      if (data) {
        ...
        // if provided either start date or end date
          ...
          // const input = [...filteredLogs];

          // // input[0]['duration'] = 2;

          // // console.log(input[0]['duration']);

          // delete input['duration'];

          // console.log(input);

          // // format the date in to be presented into dd/mm/yyyy
          // input.forEach(exerciseLog => {
          //   // need to remove as it only accepts date objects so can't overwrite with new dd/mm/yyyy format
          //   delete exerciseLog.date;

          //   // let editDt =
          //   //   dt.getDate() + '/' + (dt.getMonth() + 1) + '/' + dt.getFullYear();

          //   // // reintroduce the date key
          //   // exerciseLog.date = editDt;
          // });
