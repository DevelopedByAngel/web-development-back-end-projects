...
const saveForm = () => {
    ...
    // let formData = formeo.formData
    // delete formData.fields
    // let savedFormFields = Object.entries(JSON.parse(formeo.formData).fields)

    // let selectFields = savedFormFields.filter(function (field) { return field[1].tag === "select" })
    // let checkboxFields = savedFormFields.filter(function (field) { return field[1].attrs.type === "checkbox" })
    // checkboxFields = JSON.stringify(Object.fromEntries(checkboxFields));
    // selectFields = JSON.stringify(Object.fromEntries(selectFields));


    const formDataInput = document.getElementById('form_data_input');
    formDataInput.value = formeo.formData
    const formSaver = document.getElementById('form_saver');
    formSaver.submit()
}
...
// var url = '/formprocessor/new/';
// var data = new FormData();
// data.append('form_data', formeo.formData)
                ...
                for (var e, t = this, o = this, r = {
                    ...
                    action: {
                        click: function (e) {
                            ...
                            // console.log($(e.target).closest('li').find('#bulk-upload')[0])
                            // // for bulk upload button toggle
                            // let bulkButton = document.getElementById("bulk-upload");
                            // bulkButton.classList.toggle("hidden");
                            // // bulkButton.style.display = "hidden"

                            let edit = $(e.target).closest('li').find('.add-options')[0]
                            ...
                            //     console.log('1')
                            //     // append                               
                            //     $($(e.target).closest('li').find('.add-options')[0]).removeClass("hide").addClass('show')
                            ...
                            //     // remove
                            //     console.log('0')
                            //     $($(e.target).closest('li').find('.add-options')[0]).removeClass("show").addClass('hide')
                            // }
                ...
                return {
                    ...
                    content: [{
                        ...
                        attrs: {
                            id: "bulk-upload",
                            type: "button",
                            className: "add-options hide",

                        },
                        content: "Bulk Upload Options",
                        action: {
                            click: function (o) {

                                currentIdEdit = ($(o.target).closest('li').attr('id'))
