                    ...
                    content: [{
                        ...
                        action: {
                            click: function (o) {
                                ...
                                // input.setAttribute("id", `bulk-${fieldId}`)
                                // node.appendChild(input);
                                // document.getElementById(fieldId).appendChild(node)



                                // let options = prompt("Paste all options here")
